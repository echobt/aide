      ...
      [
        {
          ...
          title: t(
            'extension.config.expertCodeEnhancerPromptList.databaseQueries'
          ),
          prompt:
        ...
        },
        {
          match: ['**/*.vue', '**/*.tsx', '**/*.jsx'],
          title: t(
            'extension.config.expertCodeEnhancerPromptList.splitComponents'
          ),
          prompt:
        ...
        {
          match: '**/*',
          title: t('extension.config.expertCodeEnhancerPromptList.dry'),
          prompt:
        ...
        {
          match: '**/*',
          title: t('extension.config.expertCodeEnhancerPromptList.solid'),
          prompt:
        ...
        },
        {
          match: '**/*',
          title: t(
            'extension.config.expertCodeEnhancerPromptList.designPatterns'
          ),
          prompt:
        ...
        {
          match: '**/*',
          title: t('extension.config.expertCodeEnhancerPromptList.cleanliness'),
          prompt:
        ...
        },
        {
          match: '**/*',
          title: t(
            'extension.config.expertCodeEnhancerPromptList.optimizeConditionals'
          ),
          prompt:
        ...
        {
          match: '**/*',
          title: t('extension.config.expertCodeEnhancerPromptList.performance'),
          prompt:
        ...
        {
          match: '**/*',
          title: t('extension.config.expertCodeEnhancerPromptList.security'),
          prompt:
        ...
        },
        {
          ...
          title: t('extension.config.expertCodeEnhancerPromptList.concurrency'),
          prompt:
        ...
        //         {
        //           match: '**/*',
        //           title: t('extension.config.expertCodeEnhancerPromptList.angryCritique'),
