...
// Tab dimensions based on Figma design specs
  ...
  const getTabStyle = () => {
    ...
    // Figma design: Active tab merges seamlessly with editor (var(--cortex-bg-primary))
    if (props.isActive) {
      ...
      baseStyle.color = decorationColor ?? "var(--cortex-text-primary, var(--cortex-text-primary))";
      baseStyle["box-shadow"] = "none";
      baseStyle["z-index"] = "10";
      // Active tab: NO border, merges with editor
      baseStyle.border = "none";
    } else {
      // Inactive tabs: var(--cortex-bg-secondary) background, muted text
      baseStyle.height = "100%";
      baseStyle["border-radius"] = "0";
      ...
      if (decorationColor) {
        ...
        // Figma design: inactive tabs have more muted text (#666 vs var(--cortex-text-inactive))
